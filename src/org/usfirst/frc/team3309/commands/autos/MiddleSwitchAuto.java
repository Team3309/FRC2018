     ...
     //   addSequential(new WaitCommand(1.0));
        ...
        if (DriverStation.getInstance().getGameSpecificMessage().length() > 0) {
            ...
            if (isLeftSwitch) {
                ...
                addSequential(new LiftElevate(AssemblyLocation.SWITCH, 4.0));
                ...
                /* second cube */
                addParallel(new WaitAndMoveAssembly(0.5, AssemblyLocation.INTAKE));
                addSequential(new DriveArc(Length.fromInches(34), -77, 26000, true, true)); // -81
                ...
                addSequential(new DriveEnd());
                addSequential(new DriveTurn(-90, 1.3, true));
                addSequential(new DriveStraight(9, 26000, true, true));
                addSequential(new DriveArc(Length.fromInches(70), -80, 27000, false, 3.0));
