    ...
    public void start() {
        ...
        if (DriverStation.getInstance().getGameSpecificMessage().length() > 0) {
            if (Robot.isLeftSwitch()) {
                ...
                addSequential(new DriveStraight(37, 20000, true));
                addSequential(new DriveStraight(6, 17000, true));
                ...
                addSequential(new DriveStraight(47, 25000, true));
                addSequential(new DriveStraight(28, 17000, true));
                ...
                addSequential(new DriveStraight(12, 14000, true));
                addSequential(new ArmsClamp());
                addSequential(new WaitCommand(0.8));
                addSequential(new RollersSetIn(false));
                addParallel(new MoveAssembly(AssemblyLocation.EXCHANGE_ZONE));
