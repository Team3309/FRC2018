    ...
    public void start() {
        ...
        if (DriverStation.getInstance().getGameSpecificMessage().length() > 0) {
            if (Robot.isLeftSwitch()) {
                ...
                /* second cube */
                addParallel(new WaitAndMoveAssembly(0.5, AssemblyLocation.INTAKE));
                addSequential(new DriveArc(Length.fromInches(30), -82, 28000, true, true));
                addSequential(new DriveTurn(0, 1.0, true));
                addParallel(new RollersSetIn(true));
                addSequential(new DriveStraight(17, 17000, 0));
                addSequential(new ArmsClamp());
                ...
                addSequential(new DriveArc(Length.fromInches(25), -73, 26000, true, true));
                addSequential(new DriveTurn(0, 1.0, true));
                addParallel(new RollersSetIn(true));
                addSequential(new DriveStraight(30, 15000, 0));
                addSequential(new ArmsClamp());
                ...
                addSequential(new DriveTurn(-90, 0.4, true));
                addSequential(new WaitCommand(0.1));
                addSequential(new DriveStraight(10, 26000, true, true));
                addSequential(new DriveArc(Length.fromInches(25), -50, 27000, false, true));
