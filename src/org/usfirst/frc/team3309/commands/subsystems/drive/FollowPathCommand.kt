...
class FollowPathCommand(private val path : Path, private val reverse : Boolean = false) : Command() {
    val pathFollower = PathFollower(path,reverse, PathFollower.Parameters(Lookahead(12.0,24.0,9.0,144.0),
            0.0,6.03309,0.01,0.025,1.1,0.05,120.0,60.0,0.75,12.0,9.0))
