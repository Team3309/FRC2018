...
class FollowPathCommand(private val path : Path, private val reverse : Boolean = false) : Command() {
    val pathFollower = PathFollower(path,reverse, PathFollower.Parameters(Lookahead(6.0,18.0,6.0,75.0),
            0.0000013309,1.9,0.016,0.021,1.0,0.05,75.0,90.0,0.75,12.0,3.0))
