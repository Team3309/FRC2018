...
public class PIDController extends Controller2<Double, Double, Double> implements Resettable, Finishable {
    ...
    private org.usfirst.frc.team3309.lib.controllers.pid.PIDConstants pidConstants;
    ...
    public PIDController(org.usfirst.frc.team3309.lib.controllers.pid.PIDConstants pidConstants) {
