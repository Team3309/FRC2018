package src.org.usfirst.frc.team3309.lib.controllers.pid;
...
public class PIDVelocityController extends Controller3<Double, Double, Double, Double> {
    ...
    public PIDVelocityController(org.usfirst.frc.team3309.lib.controllers.pid.PIDConstants pidConstants, double v) {
        pidPositionController = new org.usfirst.frc.team3309.lib.controllers.pid.PIDController(pidConstants);
        this.vScalar = v;
    }

    public PIDVelocityController(org.usfirst.frc.team3309.lib.controllers.pid.PIDConstants pidConstants, double v, double a) {
        this(pidConstants, v);
        this.aScalar = a;
    }
